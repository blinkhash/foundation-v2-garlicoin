...
describe('Test daemon functionality', () => {
  ...
  test('Test daemon initialization [3]', (done) => {
    ...
    const daemon = new Daemon(daemonsCopy);
    const expected = '[{"error":{"code":-1,"message":"Unauthorized RPC access. Invalid RPC username or password"},"response":null,"instance":{"host":"127.0.0.1","port":"42069","username":"foundation","password":"foundation","index":0},"data":"{\\"error\\":null,\\"result\\":null,\\"instance\\":\\"nocktest\\"}"}]';
    daemon.checkInstances((error, response) => {
