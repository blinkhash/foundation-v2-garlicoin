...
describe('Test pool functionality', () => {
  ...
  test('Test pool workers handling [12]', () => {
    ...
    worker2.times = 49.1;
    const expected = {
      'MJXo3Yipi2UoZCxqhPZeWAe3tTnxMRrxjR': { 'immature': 9570.00569668, 'generate': 0 },
      'MJXo3Yipi2UoZCxqhPZeWAe3tTnxMRrxjS': { 'immature': 429.99430332, 'generate': 0 }};
