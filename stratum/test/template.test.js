...
describe('Test template functionality', () => {
  ...
  test('Test generation transaction handling', () => {
    ...
    expect(template.generation[1]).toStrictEqual(Buffer.from('000000000200f2052a0100000017a914749ef63debf11d3d488eb673f7730eeba205c962870000000000000000266a24aa21a9ede2f61c3f71d1defd3fa999dfa36953755c690689799962b48bebd836974e8cf900000000', 'hex'));
  });
  ...
  test('Test coinbase serialization [1]', () => {
    ...
    expect(coinbase.slice(51)).toStrictEqual(Buffer.from('000000000200f2052a0100000017a914749ef63debf11d3d488eb673f7730eeba205c962870000000000000000266a24aa21a9ede2f61c3f71d1defd3fa999dfa36953755c690689799962b48bebd836974e8cf900000000', 'hex'));
  });
